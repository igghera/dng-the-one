 ...
 */
class WaterMeshCustom extends Mesh {
    ...
    /**
     * The movement speed on the X axis
     *
     * @type {UniformNode<float>}
		 * @default 1
     */
    this.speedX = uniform( options.speedX !== undefined ? options.speedX : 1 );

    /**
     * The movement speed on the Y axis
     *
     * @type {UniformNode<float>}
		 * @default 1
     */
    this.speedY = uniform( options.speedY !== undefined ? options.speedY : 1 );
     ...
     * @type {UniformNode<float>}
		 * @default 1
     */
    this.stretchX = uniform( options.stretchX !== undefined ? options.stretchX : 1 );
     ...
     * @type {UniformNode<float>}
		 * @default 1
     */
    this.stretchY = uniform( options.stretchY !== undefined ? options.stretchY : 1 );
      ...
      const uvStretched = uv.div(vec2(this.stretchX, this.stretchY));

			const uv0 = add( div( uvStretched, 103 ), vec2( div( offset.mul(this.speedX), 17 ), div( offset.mul(this.speedY), 29 ) ) ).toVar();
			const uv1 = div( uvStretched, 107 ).sub( vec2( div( offset.mul(this.speedX), - 19 ), div( offset.mul(this.speedY), 31 ) ) ).toVar();
			const uv2 = add( div( uvStretched, vec2( 8907.0, 9803.0 ) ), vec2( div( offset.mul(this.speedX), 101 ), div( offset.mul(this.speedY), 97 ) ) ).toVar();
			const uv3 = sub( div( uvStretched, vec2( 1091.0, 1027.0 ) ), vec2( div( offset.mul(this.speedX), 109 ), div( offset.mul(this.speedY), - 113 ) ) ).toVar();
